'use client'
import { Breadcrumb, BreadcrumbItem, Container, Nav, Row, Tab } from "react-bootstrap"
// import { Form, Link } from "react-router-dom"
// import './Contact.css'
import amritsar from '/public/Images/amritsar.webp';
import dubai from '/public/Images/dubai.webp';
import canada from '/public/Images/canadaimg.webp';
import Mumbai from '/public/Images/bang.webp';
import contactImg from '/public/Images/contact_img.webp';
                            ...
                            <Row>
                                <div className="col-12 col-lg-3 col-md-6 col-sm-12 cities text-center">
                                    <div className="city-img">
                                        <Image src={amritsar} alt="Contact Best IT Company in Chandigarh" />
                                    </div>
                                    <div className="img_content py-5 rounded-4 ">
                                        ...
                                        <Link href={"https://maps.app.goo.gl/4HYCGEiryydf54xdA"} target='_blank'>
                                ...
                                <div className="col-12 col-lg-3 col-md-6 col-sm-12 cities text-center">
                                    <div className="city-img">
                                        <Image src={canada} alt="Best Software Development Consultation in Chandigarh" />
                                    </div>
                                    <div className="img_content py-5 rounded-4 ">
                                        <div className="img_name mt-3">
                                            <h3>Canada</h3>
                                        ...
                                        <Link href={"https://maps.app.goo.gl/oAMtDXT9D6Xc4MYq7"} target='_blank'>
                                            <button className="btn_loc">View Location</button>
                                        </Link>
                                    </div>
                                </div>
                                <div className="col-12 col-lg-3 col-md-6 col-sm-12 cities text-center">
                                    <div className="city-img">
                                        <Image src={Mumbai} alt="Hire Expert Shopify Developers in Chandigarh" />
                                    </div>
                                    <div className="img_content py-5 rounded-4 ">
                                        <div className="img_name mt-3">
                                            <h3>Mumbai</h3>
                                        ...
                                        <Link href={"https://maps.app.goo.gl/tSpBT45db7BvRm2f7"} target='_blank'>
                                            <button className="btn_loc">View Location</button>
                                        </Link>
                                    </div>
                                </div>
                                <div className="col-12 col-lg-3 col-md-6 col-sm-12 cities text-center">
                                    <div className="city-img">
                                        <Image src={dubai} alt="Contact Asvayuk Technologies for Custom Software" />
                                    </div>
                                    <div className="img_content py-5 rounded-4 ">
                                        <div className="img_name mt-3">
                                            <h3>Dubai</h3>
                                        ...
                                        <Link href={"https://maps.app.goo.gl/A6gWMfVuYWzL7mBF9"} target='_blank'>
                                            <button className="btn_loc">View Location</button>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div className="contact_form">
                            <div className="row">
                                <div className="col-lg-5 contact_form_img">
                                    <Image src={contactImg} alt="Book a Free Consultation – Web Development Mohali" />
                                </div>
