...
import lowcodeBanner from "/public/Images/banners-14.webp";
...
import lowcodeImg from "/public/Images/lowcode.webp";
    ...
    <>
      <main>
        <HeroServices
          ...
          pagePara={
            "With Asvayuk Technologies's future-oriented low-code development services, you can create scalable, customized, and enterprise-grade web, mobile, and intranet applications, becoming a pioneer of digital transformation."
          }
          ...
          <div className="container">
            <div className="col-12">
              <div className="peformance_card2_heading text-center">
                ...
                <p className="mt-3">
                  Our OutSystems and Mendix certified developers, consultants,
                  and MVPs are adept at implementing low-code and no-code
                  solutions, ensuring that your project is in capable hands..
                </p>
              </div>
...
"
                      cardParaGraph={
                        <>
                          Our certified OutSystems consultants conduct a
                          comprehensive evaluation of your existing
                          infrastructure to define the scope for OutSystems app
                          development or optimization. We strategize the
...
"
                      cardParaGraph={
                        <>
                          {" "}
                          Drawing on our extensive expertise in rapid app
                          development using OutSystems or Mendix, our certified
                          professionals craft bespoke web, mobile, and intranet
                          applications aligned with your business growth
                          objectives. Expect responsive designs tailored to your
                          unique requirements.
                        </>
                      }
                    />
...
"
                      cardParaGraph={
                        <>
                          Unlock the full potential of your applications and
                          establish a connected and agile digital ecosystem with
                          our dedicated integration specialists. We facilitate
                          seamless integration of your enterprise apps with
                          third-party tools to enhance efficiency and
                          productivity.
                        </>
                      }
                    />
...
"
                      cardParaGraph="Navigate the entire lifecycle of platform upgrades and migrations seamlessly with our skilled developers. From analysis and planning to execution, we ensure minimal downtime and zero data loss, safeguarding your business continuity.
...
"
                      cardParaGraph="Ensure the continued performance and security of your applications with Asvayuk Technologies . Our seasoned developers offer round-the-clock support, on-demand maintenance, and technical assistance to keep your apps running smoothly."
                    />
                  </div>
                  <div className="col-lg-4 pb-4 d-flex">
                    <ServicesCard
...
"
                      cardParaGraph="Scale your development capabilities and accelerate project timelines by leveraging our flexible outsourcing models. Whether you need OutSystems Champions, Mendix consultants, or MVPs, we provide skilled professionals to augment your team as per your evolving needs."
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-7 col-md-6 col-sm-12 col-12">
                  <div className="tool-heading lowCodeExp">
                    ...
                    <p className="mt-4">
                      At Asvayuk Technologies , we utilize a variety of advanced
                      tools to expedite the development process and empower our
                      clients to realize their ideas effortlessly.
                    </p>
                  </div>
