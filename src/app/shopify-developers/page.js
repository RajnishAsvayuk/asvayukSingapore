                ...
                <div className="bannerAreaTop">
                  ...
                  <div className="bannerAreaTop_content">
                    ...
                    <p className="text-white">
                      At Asvayuk Technologies Private Ltd., we are a leading
                      Shopify website design company in Singapore, specializing
                      in crafting visually appealing, user-friendly, and
                      high-performance Shopify websites. As a top Shopify
                      development company in Singapore, we help businesses build
                      their online presence with expert Shopify web development
                      services. Our team of skilled Shopify web developers in
                      Singapore is dedicated to delivering outstanding results,
                      ensuring that your e-commerce store is not only attractive
                      but also fully functional, fast, and scalable.
                    </p>
                  </div>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-65 col-sm-12 ">
                <div className="mt-5">
                  <h2>Streamline Shopify Website Development in Singapore</h2>
                  <p className="my-3">
              ...
              <div className="col-lg-6 mt-2">
                ...
                <div className="about-item text-white">
                  ...
                  <p className="font_16 text-white pt-1">
                    ...
                    Here’s why businesses prefer our Shopify development
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Hire Shopify developers to develop responsive, interactive,
                    and user-friendly themes tailored to your retail industry
                    and business needs.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Our expert team ensures high-class Shopify App development
                    using the latest tools and technologies for seamless
                    functionality.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Hire Shopify experts to seamlessly integrate multiple
                    payment gateways, CMS, or other third-party APIs relevant to
                    your business model.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Count on our Shopify experts for smooth store migration and
                    ongoing maintenance to ensure seamless operation of your
                    eCommerce store.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Our skilled and experienced Shopify development team
                    provides guidance and support to optimize your store for
                    search engines and boost visibility.
                  </p>
                </div>
              </div>
            </div>
