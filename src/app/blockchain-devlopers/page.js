...
import work2 from "/public/Images/blockchainwork1.png";
import work3 from "/public/Images/work3.png";
import ReactNativeSmallBan2 from "/public/Images/blockImg.png";
import ReactNativeSmallBan3 from "/public/Images/blockImg2.jpg";
                ...
                <div className="bannerAreaTop">
                  ...
                  <div className="bannerAreaTop_content">
                    ...
                    <p className="text-white">
                      ...
                      business needs. Our team of expert developers is dedicated
                      to building secure, scalable, and forward-thinking
                      blockchain applications across a wide range of industries.
                    </p>
                  </div>
          ...
          <div className="container">
            <div className="section-title">
              <h2 className="font_36 font_weight_semi_bold text-capitalize mb-0 color_242424 mt-2">
                Why Choose Asvayuk Technologies for Blockchain Development in
                Singapore?
              </h2>
            </div>
            <div className="row">
                  ...
                  <div className="move">
                    <div className="shape text-center">
                      <FaShieldAlt
                        ...
                        alt="Expert Blockchain Developers"
                      />
                    </div>
                    ...
                    <p>
                      Our skilled developers bring deep expertise in building
                      secure and scalable blockchain solutions tailored to your
                      business needs.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-xs-12 col-sm-12 col-md-4">
                <div className="single-features-light text-center">
                  <div className="move">
                    <div className="shape">
                      <IoIosStopwatch alt="Custom Solutions for Your Business" />
                    </div>
                    <h3 className="font_22 font_weight_extra_bold">
                      <a>Custom Solutions for Your Business</a>
                    </h3>
                    <p>
                      We provide bespoke blockchain systems designed to address
                      your unique business challenges, ensuring maximum
              ...
              <div className="col-xs-12 col-sm-12 col-md-4">
                <div className="single-features-light text-center">
                  <div className="move">
                    <div className="shape">
                      <FaQuestionCircle alt="24/7 Customer Support" />
                    </div>
                    <h3 className="font_22 font_weight_extra_bold">
                      <a>24/7 Customer Support</a>
                    </h3>
                    <p>
                      We provide continuous support, ensuring your blockchain
                      projects are smoothly implemented and any issues are
                      quickly addressed.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-6 mt-2">
                ...
                <div className="about-item text-white">
                  <p className="font_16 text-white pb-2">
                    ...
                    applications that give your business a competitive edge.
                  </p>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    ...
                    error-free. Often work with specific programming languages
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    ...
                    Skilled in JavaScript, React, or Angular for web
                    development.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="service-box position-relative">
                  ...
                  <p>
                    ...
                    blockchain. Ensure smooth integration of blockchain systems
                    with existing infrastructure. Often proficient in Node.js,
                    Python, or Go.
                  </p>
                </div>
              </div>
