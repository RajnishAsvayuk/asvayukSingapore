...
import work2 from "/public/Images/crypotoImg3.png";
import work3 from "/public/Images/crypotoImg2.png";
import ReactNativeSmallBan2 from "/public/Images/SmartContractImg3.svg";
import ReactNativeSmallBan3 from "/public/Images/SmartContractImg2.svg";
          ...
          <div className="container">
            <div className="section-title">
              <h2 className="font_36 font_weight_semi_bold text-capitalize mb-0 color_242424 mt-2">
                Why Choose Asvayuk Technologies for Smart Contract Development?
              </h2>
            </div>
              ...
              <div className="col-lg-6 mt-2">
                ...
                <div className="about-item text-white">
                  <p className="font_16 text-white pb-2">
                    Asvayuk Technologies is a trusted leader in smart contract
                    development, delivering secure, automated, and
                    high-performance blockchain solutions. Our expertise ensures
                    transparency, accuracy, and reliability for businesses
                    adopting blockchain technology.
                  </p>

                  <p className="font_16 text-white pt-1">
                    From concept to deployment, we provide end-to-end smart
                    contract services tailored to your business needs. Our
                    solutions help streamline operations, reduce manual
                    intervention, and enhance security across decentralized
                    systems.
                  </p>
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Learn the fundamentals of smart contracts, including how
                    they work, their purpose, and how they automate processes on
                    blockchain networks.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Explore Ethereum, BNB Chain, Solana, and other leading
                    blockchain platforms used for building and deploying smart
                    contracts.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="service-box position-relative">
                  ...
                  <h3 className="color_343a40">Smart Contract Programming</h3>
                  <p>
                    Master popular languages like Solidity, Vyper, and Rust to
                    develop secure and scalable smart contracts.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Work with tools like Remix, Truffle, and Hardhat to write,
                    test, debug, and deploy smart contracts efficiently.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Learn smart contract security practices, conduct audits, and
                    ensure protection from vulnerabilities and exploits.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="service-box position-relative">
                  ...
                  <p>
                    Deploy contracts on testnets and mainnets with complete
                    support for upgrades, monitoring, and long-term maintenance.
                  </p>
                </div>
              </div>
            </div>
                      ...
                      <div className="single-work-process position-relative">
                        ...
                        <div className="work-process-content mt-4">
                          ...
                          <p className="mb-0 font_weight_light">
                            We begin by understanding your smart contract
                            requirements, analyzing the business use case, and
                            selecting the most suitable blockchain platform for
                            your project.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="single-work-process position-relative">
                        ...
                        <div className="work-process-content mt-4">
                          ...
                          <p className="mb-0 font_weight_light">
                            ...
                            by choosing the right blockchain network and
                            finalizing architecture to ensure maximum security,
                    ...
                    <Col lg={3} md={6} sm={12}>
                      <div className="single-work-process position-relative">
                        ...
                        <div className="work-process-content mt-4">
                          ...
                          <p className="mb-0 font_weight_light">
                            Our experts design and develop secure, reliable, and
                            high-performing smart contracts tailored to your
                            business goals using the latest blockchain
                            technologies.
                          </p>
                        </div>
                      </div>
                    ...
                    <Col lg={3} md={6} sm={12}>
                      <div className="single-work-process position-relative">
                        ...
                        <div className="work-process-content mt-4">
                          ...
                          <p className="mb-0 font_weight_light">
                            We conduct rigorous testing to ensure the smart
                            contract works flawlessly. After validation, we
                            deploy it on the blockchain and ensure smooth
