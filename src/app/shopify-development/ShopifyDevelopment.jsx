    ...
    <>
      <main>
        <HeroServices
          ...
          pageHeading={"Leading Shopify Website Design Company in Singapore!"}
          pagePara={
            "Asvayuk Technologies is a top-rated Shopify website design company in Singapore, specializing in high-performance and user-friendly Shopify websites. Build your online presence with us."
          }
        ...
        <section className="magento_service_card">
          <Container>
            <div className="card_heading text-center">
              ...
              <p>We offer a full spectrum of services to ensure your Shopify store is powerful, effective, and ready to compete in the Singapore e-commerce landscape.</p>
            </div>
              ...
              <Row className="gy-4">
                <Col lg={4}>
                  <Magento_service_card
                    ...
                    cardPara="Craft bespoke Shopify stores aligned with your business objectives to deliver a unique shopping experience that stands out in SG."
                  />
                </Col>
                <Col lg={4}>
                  <Magento_service_card
                    ...
                    cardPara="Develop responsive Shopify themes tailored to match your brand identity and enhance user engagement across all devices."
                  />
                </Col>
                <Col lg={4}>
                  <Magento_service_card
        ...
        <Experience
          expTitle={<>Why Choose Asvayuk Technologies For Shopify Web Development In Singapore?</>}
          ExpPara={
            <>
              Our Shopify website design services in Singapore are crafted to enhance the shopping experience, boost conversions, and help your online store grow.
            </>
          }
          point1="Expert Shopify Developers"
          pointPara1={
            <>
